...
function pureRender(component: any) {
  component.prototype.shouldComponentUpdate =
    function shouldComponentUpdate(props: any, state: any) {
...
const defaultFormatter = (value: any) => (
  _.isArray(value) && util.isNumOrStrAndNotNaN(value[0]) &&
    util.isNumOrStrAndNotNaN(value[1]) ? value.join(' ~ ') : value);
...
@pureRender
class DiaryTrendChartTooltipContent extends React.Component<Props & PropsDefaults> {
  static displayName = 'DiaryTrendChartTooltipContent';
